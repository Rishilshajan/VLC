    ...
    <section className="w-full py-16 md:py-24 bg-white relative overflow-hidden">
      <div className="container mx-auto px-4 flex flex-col items-center gap-16">
        ...
        <div className="flex flex-col items-center gap-6 w-full">
          {/* Heading: 42px, SemiBold, #123042, Width 863px */}
          <h2 className="font-semibold text-[42px] leading-none text-center text-[#123042] w-full max-w-[863px]">
            Vision
          </h2>
          {/* Content: Changed leading-none to leading-relaxed for better spacing */}
          <p className="font-light text-[20px] leading-relaxed text-center text-[#1D6D29] w-full max-w-[580px]">
        ...
        <div className="flex flex-col items-center gap-6 w-full">
          ...
          {/* Content: Changed leading-none to leading-relaxed */}
          <p className="font-light text-[20px] leading-relaxed text-center text-[#1D6D29] w-full max-w-[580px]">
        ...
        <div className="flex flex-col items-center gap-8 w-full">
          <h2 className="font-semibold text-[42px] leading-none text-center text-[#123042] w-full max-w-[863px] mb-4">
            Our Core Values
          </h2>
          ...
          <div className="flex flex-col gap-8">
            ...
            {/* Value 1 */}
            {/* Content: Changed leading-none to leading-relaxed */}
            <p className="max-w-[580px] text-justify font-light text-[20px] leading-relaxed text-[#1D6D29] mx-auto">
