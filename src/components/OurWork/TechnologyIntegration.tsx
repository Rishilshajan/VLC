    ...
    return (
        <section className="w-full py-12 md:py-20 bg-white">
            <div className="container mx-auto px-4">
                ...
                {/* Content Grid Container with Background Image and Gradient Overlay */}
                <div
                    className="relative w-full max-w-[1246px] mx-auto rounded-[20px] flex flex-col lg:flex-row items-center justify-center gap-0"
                    style={{
                ...
                >
                    ...
                    <div
                        className="flex-1 w-full lg:min-w-[487px] lg:max-w-[487px] p-8 md:p-12 border-[3px] border-[#0C87BE] z-20 font-poppins rounded-[20px] bg-white"
                        style={{
                            height: '598px'
                        }}
                    >
                        <h3 className="text-[#0C87BE] font-medium text-2xl md:text-[28px] mb-10">
                            Tools and Platforms
                        </h3>
                    ...
                    {/* Center Column: Icons */}
                    <div
                        className="hidden lg:flex flex-col justify-between items-center py-12 px-6 relative z-10 w-[272px] self-stretch"
                        style={{
                    ...
                    {/* Right Card: Benefits */}
                    <div
                        className="flex-1 w-full lg:min-w-[487px] lg:max-w-[487px] p-8 md:p-12 border-[3px] border-[#228B22] z-20 font-poppins rounded-[20px] bg-white"
                        style={{
                            height: '598px'
                        }}
                    >
                        <h3 className="text-[#228B22] font-medium text-2xl md:text-[28px] mb-10">
                            Benefits
                        </h3>

                        <div className="space-y-8">
                            <div>
                                <h4 className="text-[#228B22] font-medium text-[20px] mb-3">Acccurate Data</h4>
